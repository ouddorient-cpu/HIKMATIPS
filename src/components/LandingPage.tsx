    ...
    <div className="min-h-screen bg-background bg-islamic-pattern overflow-x-hidden relative">
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          >
            <div className="bg-gradient-to-b from-emerald-500/20 to-yellow-400/20 rounded-3xl p-8 max-w-md mx-auto">
      ...
      <section className="py-24 px-4 bg-emerald-900 text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 pointer-events-none">
          ...
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-emerald-400 rounded-full blur-[120px] mix-blend-screen" />
        </div>

        <div className="container mx-auto max-w-4xl relative z-10">
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            <div className="flex-1 space-y-6">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-800/50 border border-emerald-600 text-emerald-100 text-xs font-medium">
                <Sparkles className="h-3 w-3" />
                Agent Interactif
              </div>
              <h2 className="text-3xl sm:text-4xl font-bold leading-tight">
                "Vous vous rappelez d'un Hadith mais <span className="text-yellow-400">pas de la suite ?</span>"
              </h2>
              ...
              <form onSubmit={handleChatSearch} className="flex gap-2">
                <div className="relative flex-1">
                  ...
                  <Input
                    ...
                    className="pl-11 h-12 bg-emerald-800/30 border-emerald-600/50 text-white placeholder:text-emerald-400/50 rounded-xl focus-visible:ring-emerald-500"
                  />
                </div>
                <Button
                  type="submit"
                  className="h-12 px-6 bg-yellow-400 hover:bg-yellow-300 text-emerald-900 font-bold rounded-xl"
                  disabled={isSearchingChat}
                >
                  {isSearchingChat ? <span className="animate-spin h-5 w-5 border-2 border-emerald-900 border-t-transparent rounded-full" /> : "Chercher"}
                </Button>
              </form>
              ...
              <AnimatePresence>
                {hasSearched && (
                  ...
                  >
                    ...
                    <ScrollArea className="h-64 rounded-xl border border-emerald-600/50 bg-emerald-800/20">
                      <div className="p-4 space-y-4">
                        {chatResults.length === 0 ? (
                          <div className="text-center py-8 px-4 space-y-4">
                            ...
                            <div className="p-4 rounded-xl bg-yellow-400/10 border border-yellow-400/20 text-xs space-y-3">
                              <p className="text-yellow-300 font-bold uppercase tracking-wider">Conseil de l'Agent :</p>
                              ...
                              <div className="flex flex-wrap justify-center gap-2">
                                {['3ilmchar3i', 'La Voie Droite', 'La Science Légiférée'].map(site => (
                                  <span key={site} className="px-2 py-1 bg-emerald-800/50 rounded text-yellow-400 font-medium">
                                    {site}
                                  </span>
                                ))}
                              </div>
                            ...
                            <div key={i} className="p-3 bg-emerald-800/40 rounded-lg border border-emerald-700/30">
                              ...
                              <div className="flex gap-2">
                                ...
                                <Button
                                  variant="ghost"
                                  size="sm"
                                  className="h-6 p-0 px-2 text-[9px] hover:bg-emerald-700 text-emerald-300 border border-emerald-600/50"
                              ...
                              {explanation?.id === i && (
                                <motion.div
                                  ...
                                  className="mt-3 p-3 bg-emerald-950/50 rounded-lg border border-yellow-400/20"
                                >
            ...
            <div className="hidden lg:block w-72 h-72 relative">
              ...
              <div className="relative z-10 w-full h-full border border-emerald-500/20 rounded-3xl bg-emerald-800/20 backdrop-blur-xl flex flex-col items-center justify-center p-8 text-center border-t-yellow-400/20 shadow-2xl overflow-hidden group">
                <div className="absolute inset-0 bg-gradient-to-tr from-yellow-400/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
                <Image
                  src="https://res.cloudinary.com/db2ljqpdt/image/upload/v1770580517/ChatGPT_Image_2_f%C3%A9vr._2026_23_43_44_qmfwbc_1_f4huf1.png"
                  alt="Assistant"
                  width={80}
                  height={80}
                  className="rounded-2xl mb-6 shadow-2xl relative z-10 ring-2 ring-yellow-400/30"
                />
